...
//    /// 
//    /// </summary>
//    public class GoogleXmlApiPaymentGateway : IPaymentGateway
//    {
//        private static readonly ILog log = LogManager.GetLogger(typeof(GoogleXmlApiPaymentGateway));

//        #region Constructors

//        public GoogleXmlApiPaymentGateway(NewOrderNotification newOrder)
//        {
//            if (newOrder.financialorderstate == FinancialOrderState.CHARGED)
//            {
//                transactionID = newOrder.googleordernumber;
//                this.approvalCode = newOrder.serialnumber;
//                this.rawResponse = newOrder.ToString();
//                this.customerID = newOrder.buyerid.ToString();
//            }
...
//        //public GoogleXmlApiPaymentGateway(string login, string transactionKey)
//        //{
...
//        private string provider = "mojoPortal Google Checkout Payment Gateway";
...
//        private string testUrl = "https://sandbox.google.com/checkout/api/checkout/v2/merchantCheckout/Merchant/MERCHANT_ID";
//        private string productionUrl = "https://checkout.google.com/api/checkout/v2/merchantCheckout/Merchant/MERCHANT_ID";
