...
namespace mojoPortal.Data
{
    ...
    public static class DBTag
    {
            ...
            Guid createdBy)
        {
            ...
            arParams[1] = new MySqlParameter("?VocabularyGuid", MySqlDbType.VarChar, 36);
            ...
            arParams[5] = new MySqlParameter("?Tag", MySqlDbType.VarChar, 255);
            ...
            arParams[8] = new MySqlParameter("?ModifiedUtc", MySqlDbType.DateTime);
            ...
            arParams[10] = new MySqlParameter("?ItemCount", MySqlDbType.Int32);
            ...
            Guid modifiedBy)
        {
            ...
            arParams[2] = new MySqlParameter("?Tag", MySqlDbType.VarChar, 255);
            arParams[2].Direction = ParameterDirection.Input;
            arParams[2].Value = tag;

            arParams[3] = new MySqlParameter("?ModifiedUtc", MySqlDbType.DateTime);
            arParams[3].Direction = ParameterDirection.Input;
            arParams[3].Value = modifiedUtc;

            arParams[4] = new MySqlParameter("?ModifiedBy", MySqlDbType.VarChar, 36);
            arParams[4].Direction = ParameterDirection.Input;
