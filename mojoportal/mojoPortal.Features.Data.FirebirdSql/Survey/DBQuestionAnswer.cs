...
namespace SurveyFeature.Data
{
    ...
    public static class DBQuestionAnswer
    {
            ...
            string answer)
        {
            ...
            arParams[0] = new FbParameter("@AnswerGuid", FbDbType.Char, 36);
            ...
            arParams[2] = new FbParameter("@ResponseGuid", FbDbType.Char, 36);
            arParams[2].Direction = ParameterDirection.Input;
            arParams[2].Value = responseGuid.ToString();

            arParams[3] = new FbParameter("@Answer", FbDbType.VarChar);
            arParams[3].Direction = ParameterDirection.Input;
            arParams[3].Value = answer;

            arParams[4] = new FbParameter("@AnsweredDate", FbDbType.TimeStamp);
