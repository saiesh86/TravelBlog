...
namespace mojoPortal.Business
{
    ...
    public class ContentMetaRespository
    {
        ...
        {
            if (contentGuid == null) { return string.Empty; }
            if (contentGuid == Guid.Empty) { return string.Empty; }
            ...
            foreach (ContentMeta meta in metaList)
            {
                ...
                metaString.Append("name=\"" + meta.Name.Replace("'", "&#39;").Replace("\"", "&#34;") + "\" ");
                if (meta.Scheme.Length > 0)
                {
                    metaString.Append("scheme=\"" + meta.Scheme.Replace("'", "&#39;").Replace("\"", "&#34;") + "\" ");
                }

                metaString.Append("content=\"" + meta.MetaContent.Replace("'", "&#39;").Replace("\"", "&#34;") + "\" ");
