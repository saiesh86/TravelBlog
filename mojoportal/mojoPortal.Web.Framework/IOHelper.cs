...
namespace mojoPortal.Web.Framework
{
    public static class IOHelper
    {
        ...
        public static string ToCleanFileName(this string s)
        {
            ...
            return s.ToLower().RemoveInvalidPathChars().RemoveLineBreaks().Replace("'", string.Empty).Replace("\"", string.Empty).Replace("  ", " ").Replace(" ", "-").Replace("&", string.Empty).Replace("@", string.Empty).Replace("$", string.Empty).Replace("#", string.Empty);
