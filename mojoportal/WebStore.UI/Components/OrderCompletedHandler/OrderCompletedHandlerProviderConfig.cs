...
{
    public sealed class OrderCompletedHandlerProviderConfig
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(OrderCompletedHandlerProviderConfig));
        ...
        public static OrderCompletedHandlerProviderConfig GetConfig()
        {
            try
            {
                if (
                    (HttpRuntime.Cache["OrderCompletedHandlerProviderConfig"] != null)
                    && (HttpRuntime.Cache["OrderCompletedHandlerProviderConfig"] is OrderCompletedHandlerProviderConfig)
                )
                {
                    return (OrderCompletedHandlerProviderConfig)HttpRuntime.Cache["OrderCompletedHandlerProviderConfig"];
                }

                OrderCompletedHandlerProviderConfig config = new OrderCompletedHandlerProviderConfig();

                String configFolderName = "~/WebStore/OrderCompletedHandlers/";
                ...
                System.Web.HttpRuntime.Cache.Insert(
                    "OrderCompletedHandlerProviderConfig",
                    config,
