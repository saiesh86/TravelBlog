...
namespace mojoPortal.Data
{
    public static class DBCategory
    {
            ...
            Guid createdBy)
        {
            ...
            arParams[5] = new SqlCeParameter("@Category", SqlDbType.NVarChar, 255);
            ...
            arParams[7] = new SqlCeParameter("@ItemCount", SqlDbType.Int);
            ...
            arParams[10] = new SqlCeParameter("@ModifiedUtc", SqlDbType.DateTime);
        ...
        {  
            ...
            arParams[2] = new SqlCeParameter("@Category", SqlDbType.NVarChar, 255);
            arParams[2].Direction = ParameterDirection.Input;
            ...
            arParams[4] = new SqlCeParameter("@ModifiedUtc", SqlDbType.DateTime);
            arParams[4].Direction = ParameterDirection.Input;
            arParams[4].Value = modifiedUtc;

            arParams[5] = new SqlCeParameter("@ModifiedBy", SqlDbType.UniqueIdentifier);
            arParams[5].Direction = ParameterDirection.Input;
            arParams[5].Value = modifiedBy;
        ...
        public static bool UpdateItemCount(Guid guid)
        {
            ...
            int count = DBCategoryItem.GetCountByCategory(guid);
