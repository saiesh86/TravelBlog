...
namespace mojoPortal.Data
{
    public static class DBContentTemplate
    {
            ...
            DateTime createdUtc)
        {
            ...
            arParams[3] = new SqlCeParameter("@ImageFileName", SqlDbType.NVarChar, 255);
            ...
            arParams[5] = new SqlCeParameter("@Body", SqlDbType.NText);
            arParams[5].Direction = ParameterDirection.Input;
            arParams[5].Value = body;

            arParams[6] = new SqlCeParameter("@AllowedRoles", SqlDbType.NText);
            arParams[6].Direction = ParameterDirection.Input;
            arParams[6].Value = allowedRoles;

            arParams[7] = new SqlCeParameter("@CreatedByUser", SqlDbType.UniqueIdentifier);
            arParams[7].Direction = ParameterDirection.Input;
            arParams[7].Value = createdByUser;

            arParams[8] = new SqlCeParameter("@LastModUser", SqlDbType.UniqueIdentifier);
            arParams[8].Direction = ParameterDirection.Input;
            arParams[8].Value = createdByUser;

            arParams[9] = new SqlCeParameter("@CreatedUtc", SqlDbType.DateTime);
            ...
            DateTime lastModUtc)
        {
            ...
            arParams[7] = new SqlCeParameter("@LastModUser", SqlDbType.UniqueIdentifier);
            arParams[7].Direction = ParameterDirection.Input;
            arParams[7].Value = lastModUser;
