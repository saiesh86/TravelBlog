...
namespace mojoPortal.Data
{
    public static class DBPaymentLog
    {
            ...
            decimal freight)
        {
            ...
            arParams[6] = new SqlCeParameter("@ResponseCode", SqlDbType.NChar, 1);
            arParams[6].Direction = ParameterDirection.Input;
            ...
            arParams[10] = new SqlCeParameter("@CcvCode", SqlDbType.NChar, 1);
            arParams[10].Direction = ParameterDirection.Input;
            arParams[10].Value = ccvCode;

            arParams[11] = new SqlCeParameter("@CavCode", SqlDbType.NChar, 1);
            arParams[11].Direction = ParameterDirection.Input;
