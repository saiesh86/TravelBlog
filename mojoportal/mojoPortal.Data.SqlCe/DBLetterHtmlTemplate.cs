...
namespace mojoPortal.Data
{
    public static class DBLetterHtmlTemplate
    {
            ...
            DateTime lastModUTC)
        {
            ...
            arParams[3] = new SqlCeParameter("@Html", SqlDbType.NText);
            arParams[3].Direction = ParameterDirection.Input;
            arParams[3].Value = html;

            arParams[4] = new SqlCeParameter("@LastModUTC", SqlDbType.DateTime);
            ...
            DateTime lastModUTC)
        {
            ...
            arParams[2] = new SqlCeParameter("@Html", SqlDbType.NText);
            arParams[2].Direction = ParameterDirection.Input;
            arParams[2].Value = html;

            arParams[3] = new SqlCeParameter("@LastModUTC", SqlDbType.DateTime);
            arParams[3].Direction = ParameterDirection.Input;
