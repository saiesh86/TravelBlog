        ...
        <portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
            ...
            <div class="w-section section maincontainer">
                <div class="story-section">
                    ...
                    <div class="w-row">
                        <div class="story-section storydetail  w-col w-col-9">
                                        ...
                                        <asp:Panel ID="pnlNewComment" runat="server">
                                            <div class="settingrow">
                                                <mp:SiteLabel ID="lblCommentTitle" runat="server" ForControl="txtCommentTitle" CssClass="settinglabel"
                                                    ConfigKey="BlogCommentTitleLabel" ResourceFile="BlogResources" EnableViewState="false"></mp:SiteLabel>
                                            ...
                                            <div class="settingrow">
                                                <mp:SiteLabel ID="lblCommentUserName" runat="server" ForControl="txtName" CssClass="settinglabel"
                                                    ConfigKey="BlogCommentUserNameLabel" ResourceFile="BlogResources" EnableViewState="false"></mp:SiteLabel>
                                            ...
                                            <div id="divCommentUrl" runat="server" class="settingrow">
                                                <mp:SiteLabel ID="lblCommentURL" runat="server" ForControl="txtURL" CssClass="settinglabel"
                                                    ConfigKey="BlogCommentUrlLabel" ResourceFile="BlogResources" EnableViewState="false"></mp:SiteLabel>
                                            ...
                                            <div class="settingrow">
                                                <mp:SiteLabel ID="lblRememberMe" runat="server" ForControl="chkRememberMe" CssClass="settinglabel"
                                                    ConfigKey="BlogCommentRemeberMeLabel" ResourceFile="BlogResources" EnableViewState="false"></mp:SiteLabel>
                        ...
                        <div class="story-section storydetailrelated  w-col w-col-3">
