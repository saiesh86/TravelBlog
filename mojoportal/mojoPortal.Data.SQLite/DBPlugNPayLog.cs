...
namespace mojoPortal.Data
{
    ...
    public static class DBPlugNPayLog
    {
            ...
            decimal freight)
        {
            ...
            arParams[7] = new SqliteParameter(":ResponseCode", DbType.String, 10);
            ...
            arParams[11] = new SqliteParameter(":CcvCode", DbType.String, 10);
            arParams[11].Direction = ParameterDirection.Input;
            arParams[11].Value = ccvCode;

            arParams[12] = new SqliteParameter(":CavCode", DbType.String, 10);
            ...
            decimal freight)
        {
            ...
            arParams[6] = new SqliteParameter(":ResponseCode", DbType.String, 10);
            arParams[6].Direction = ParameterDirection.Input;
            ...
            arParams[10] = new SqliteParameter(":CcvCode", DbType.String, 10);
            arParams[10].Direction = ParameterDirection.Input;
            arParams[10].Value = ccvCode;

            arParams[11] = new SqliteParameter(":CavCode", DbType.String, 10);
            arParams[11].Direction = ParameterDirection.Input;
