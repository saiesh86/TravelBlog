...
namespace mojoPortal.Data
{
    public static class DBPaymentLog
    {
        ...
        public static int Create(
            ...
            decimal freight)
        {
            FbParameter[] arParams = new FbParameter[22];
            ...
            arParams[7] = new FbParameter("@ResponseCode", FbDbType.Char, 1);
            ...
            arParams[11] = new FbParameter("@CcvCode", FbDbType.Char, 1);
            arParams[11].Direction = ParameterDirection.Input;
            arParams[11].Value = ccvCode;

            arParams[12] = new FbParameter("@CavCode", FbDbType.Char, 1);
            ...
            arParams[21] = new FbParameter("@Provider", FbDbType.VarChar, 100);
            ...
            decimal freight)
        {
            ...
            arParams[6] = new FbParameter("@ResponseCode", FbDbType.Char, 1);
            arParams[6].Direction = ParameterDirection.Input;
            ...
            arParams[10] = new FbParameter("@CcvCode", FbDbType.Char, 1);
            arParams[10].Direction = ParameterDirection.Input;
            arParams[10].Value = ccvCode;

            arParams[11] = new FbParameter("@CavCode", FbDbType.Char, 1);
            arParams[11].Direction = ParameterDirection.Input;
