...
namespace mojoPortal.Data
{
    public static class DBContentMeta
    {
            ...
            Guid createdBy)
        {
            ...
            arParams[4] = new FbParameter("@Name", FbDbType.VarChar, 255);
            arParams[4].Direction = ParameterDirection.Input;
            arParams[4].Value = name;

            arParams[5] = new FbParameter("@Scheme", FbDbType.VarChar, 255);
            arParams[5].Direction = ParameterDirection.Input;
            arParams[5].Value = scheme;

            arParams[6] = new FbParameter("@LangCode", FbDbType.VarChar, 10);
            arParams[6].Direction = ParameterDirection.Input;
            arParams[6].Value = langCode;

            arParams[7] = new FbParameter("@Dir", FbDbType.VarChar, 3);
            arParams[7].Direction = ParameterDirection.Input;
            arParams[7].Value = dir;

            arParams[8] = new FbParameter("@MetaContent", FbDbType.VarChar);
            arParams[8].Direction = ParameterDirection.Input;
            arParams[8].Value = metaContent;

            arParams[9] = new FbParameter("@SortRank", FbDbType.Integer);
            arParams[9].Direction = ParameterDirection.Input;
            arParams[9].Value = sortRank;

            arParams[10] = new FbParameter("@CreatedUtc", FbDbType.TimeStamp);
            arParams[10].Direction = ParameterDirection.Input;
            arParams[10].Value = createdUtc;

            arParams[11] = new FbParameter("@CreatedBy", FbDbType.Char, 36);
            arParams[11].Direction = ParameterDirection.Input;
            arParams[11].Value = createdBy.ToString();

            arParams[12] = new FbParameter("@LastModUtc", FbDbType.TimeStamp);
            arParams[12].Direction = ParameterDirection.Input;
            arParams[12].Value = createdUtc;

            arParams[13] = new FbParameter("@LastModBy", FbDbType.Char, 36);
            ...
            Guid lastModBy)
        {
            ...
            arParams[2] = new FbParameter("@Scheme", FbDbType.VarChar, 255);
            arParams[2].Direction = ParameterDirection.Input;
            arParams[2].Value = scheme;

            arParams[3] = new FbParameter("@LangCode", FbDbType.VarChar, 10);
            arParams[3].Direction = ParameterDirection.Input;
            arParams[3].Value = langCode;

            arParams[4] = new FbParameter("@Dir", FbDbType.VarChar, 3);
            arParams[4].Direction = ParameterDirection.Input;
            arParams[4].Value = dir;

            arParams[5] = new FbParameter("@MetaContent", FbDbType.VarChar);
            arParams[5].Direction = ParameterDirection.Input;
            arParams[5].Value = metaContent;

            arParams[6] = new FbParameter("@SortRank", FbDbType.Integer);
            arParams[6].Direction = ParameterDirection.Input;
        ...
        public static int GetMaxSortRank(Guid contentGuid)
        {
            ...
            int maxSort = Convert.ToInt32(FBSqlHelper.ExecuteScalar(
                GetReadConnectionString(),
                sqlCommand.ToString(),
                arParams));
