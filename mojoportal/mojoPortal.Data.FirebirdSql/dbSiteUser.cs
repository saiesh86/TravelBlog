...
namespace mojoPortal.Data
{
    ...
    public static class DBSiteUser
    {
        ...
        public static int UserCount(int siteId)
        {
            ...
            int count = Convert.ToInt32(FBSqlHelper.ExecuteScalar(GetConnectionString(), sqlCommand.ToString(), arParams).ToString());
        ...
        public static bool UpdateLastPasswordChangeTime(Guid userGuid, DateTime lastPasswordChangeTime)
        {
            ...
            rowsAffected = FBSqlHelper.ExecuteNonQuery(GetConnectionString(), sqlCommand.ToString(), arParams);
            ...
            bool isLazyLoaded)
        {
            ...
            FBSqlHelper.ExecuteNonQuery(GetConnectionString(), sqlCommand.ToString(), arParams);
