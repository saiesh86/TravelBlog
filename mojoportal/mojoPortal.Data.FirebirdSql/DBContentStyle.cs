...
namespace mojoPortal.Data
{
    public static class DBContentStyle
    {
            ...
            Guid createdBy)
        {
            ...
            arParams[2] = new FbParameter("@Name", FbDbType.VarChar, 100);
            arParams[2].Direction = ParameterDirection.Input;
            arParams[2].Value = name;

            arParams[3] = new FbParameter("@Element", FbDbType.VarChar, 50);
            arParams[3].Direction = ParameterDirection.Input;
            arParams[3].Value = element;

            arParams[4] = new FbParameter("@CssClass", FbDbType.VarChar, 50);
            arParams[4].Direction = ParameterDirection.Input;
            arParams[4].Value = cssClass;

            arParams[5] = new FbParameter("@SkinName", FbDbType.VarChar, 100);
            ...
            arParams[10] = new FbParameter("@LastModBy", FbDbType.Char, 36);
        ...
        public static bool SetActivationBySkin(Guid siteGuid, string skinName, bool isActive)
        {
            ...
            arParams[2] = new FbParameter("@SkinName", FbDbType.VarChar, 100);
            arParams[2].Direction = ParameterDirection.Input;
            arParams[2].Value = skinName;

            arParams[3] = new FbParameter("@IsActive", FbDbType.SmallInt);
            arParams[3].Direction = ParameterDirection.Input;
            arParams[3].Value = intIsActive;
