...
{},g=u.insetTop,h=u.insetLeft,i=u.innerWidth,m=u.innerHeight,c=c.spacing_open;switch(a){case "north":e.min=g+f;e.max=g+d;break;case "west":e.min=h+f;e.max=h+d;break;case "south":e.min=g+m-d-c;e.max=g+m-f-c;break;case "east":e.min=h+i-d-c,e.max=h+i-f-c}}},N=function(a){return f.layout.getElementDimensions(a)},qa=function(a,b){var c=f(a),e=c.data("layoutRole"),d=c.data("layoutEdge"),j=n[d][e+"Class"],d="-"+d,g=c.hasClass(j+"-closed")?"-closed":"-open",i=g=="-closed"?"-open":"-closed",g=j+"-hover "+
(j+d+"-hover ")+(j+g+"-hover ")+(j+d+g+"-hover ");b&&(g+=j+i+"-hover "+(j+d+i+"-hover "));e=="resizer"&&c.hasClass(j+"-sliding")&&(g+=j+"-sliding-hover "+(j+d+"-sliding-hover "));return f.trim(g)},ra=function(a,b){var c=f(b||this);a&&c.data("layoutRole")=="toggler"&&a.stopPropagation();c.addClass(qa(c))},S=function(a,b){var c=f(b||this);c.removeClass(qa(c,!0))},Ia=function(a){f("body").disableSelection();ra(a,this)},sa=function(a,b){var c=b||this,e=f(c).data("layoutEdge"),d=e+"ResizerLeave";E.clear(e+
"_openSlider");E.clear(d);b?l[e].isResizing||f("body").enableSelection():(S(a,this),E.set(d,function(){sa(a,c)},200))},w=function(){return l.initialized||l.creatingLayout?!0:ta()},ta=function(){var a=n;if(!q.is(":visible"))return!1;if(!Ja("center").length)return a.showErrorMessages&&alert(C.errCenterPaneMissing),!1;l.creatingLayout=!0;f.extend(u,N(q));Sa();fa();if(a.scrollToBookmarkOnLoad){var b=self.location;b.hash&&b.replace(b.hash)}a.resizeWithWindow&&!q.data("layoutRole")&&f(window).bind("resize."+
