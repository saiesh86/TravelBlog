...
namespace mojoPortal.Web.UI
{
    ...
    /// </summary>
    public class mojoAddThisButton : HyperLink
    {
        private SiteSettings siteSettings = null;

        private bool useSkinFolderImage = false;
        public bool UseSkinFolderImage
        {
            get { return useSkinFolderImage; }
            set { useSkinFolderImage = value; }
        }

        private string skinFolderImage = string.Empty;
        public string SkinFolderImage
        {
            get { return skinFolderImage; }
            set { skinFolderImage = value; }
        }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if ((useSkinFolderImage) && (skinFolderImage.Length > 0))
            {
                this.ImageUrl = Page.ResolveUrl(SiteUtils.GetSkinBaseUrl(Page) + skinFolderImage);
            }
        }
        ...
        private void SetupNormalLink()
        {
            ...
            {
                onClickAttribute.Append("addthis_title ='" + HttpUtility.HtmlAttributeEncode(titleOfUrlToShare) + "'; ");
            }
            else
            {
