...
<RootNodeTemplate><asp:Literal ID="lit1" runat="server" EnableViewState="false" Text='<%# ItemWrapperTop %>' />
...
<NodeTemplate><asp:Literal ID="lit3" runat="server" EnableViewState="false" Text='<%# ItemWrapperTop %>' />
...
<CurrentNodeTemplate><asp:Literal ID="lit5" runat="server" EnableViewState="false" Text='<%# ItemWrapperTop %>' />
