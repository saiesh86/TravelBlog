...
namespace mojoPortal.Data
{
    ...
    public static class DBModule
    {
            ...
            int publishMode)
        {
            ...
            int moduleID = Convert.ToInt32(NpgsqlHelper.ExecuteScalar(ConnectionString.GetWriteConnectionString(),
                CommandType.Text,
                sqlCommand.ToString(),
                arParams));
            ...
            DateTime publishEndDate)
        {
            ...
            //    GetConnectionString(),
            //    CommandType.StoredProcedure,
            //    "mp_pagemodules_update(:pageid,:moduleid,:moduleorder,:panename,:publishbegindate,:publishenddate)",
            //    arParams));
        ...
        public static IDataReader GetModule(int moduleId, int pageId)
        {
            ...
            //    GetConnectionString(),
            //    CommandType.StoredProcedure,
            //    "mp_modules_selectonebypage(:moduleid,:pageid)",
            //    arParams);
